...
work_dir   = _base_.work_dir_ + "/pre_backbone_large_v1" # logges and checkpoints saved here
save_dir   = _base_.save_dir_ + "/pre_backbone_large_v1" # visualization will be saved here
