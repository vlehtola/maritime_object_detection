...
val_evaluator = [
    ...
    dict(type ="BoxPatchClassificationMetrics", patch_size=16)]
...
work_dir   = _base_.work_dir_ + "/rt_detr_pruned_vim_1920_1920_eff_fpn_v1" # logges and checkpoints saved here
save_dir   = _base_.save_dir_ + "/rt_detr_pruned_vim_1920_1920_eff_fpn_v1" # visualization will be saved here
