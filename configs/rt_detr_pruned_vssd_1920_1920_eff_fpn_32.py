...
work_dir   = _base_.work_dir_ + "/rt_detr_pruned_vssd_1920_1920_eff_fpn_32_v1" # logges and checkpoints saved here
save_dir   = _base_.save_dir_ + "/rt_detr_pruned_vssd_1920_1920_eff_fpn_32_v1" # visualization will be saved here
