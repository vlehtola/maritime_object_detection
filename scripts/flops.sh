...
/home/tinsae/miniconda3/envs/mtp/bin/python3 third_party/mmdet/tools/analysis_tools/get_flops.py $config_file

# source /home/ubuntu/fugro.madlab.marine_det/marine_det/myenv/bin/activate
# export PYTHONPATH=$(pwd)
# python third_party/mmdet/tools/analysis_tools/get_flops.py $config_file